...
import {Row,Col, Card, Button, Table, Form, Input, Checkbox, Select, Radio, Icon, message, Modal, DatePicker } from 'antd';
import axios from './../../../axios';
import Utils from './../../../utils';
import ETable from '../../../components/ETable';
import TreeNodeJGGL from './treeNodeJGGL';
import Moment from 'moment';
import './index.less';
const FormItem = Form.Item;
const Option = Select.Option;
const RadioGroup = Radio.Group;
export default class Jggl extends Component {
        ...
        return (
            <div>
                <Row gutter={16} className="container">
                    <Col span={5} className="gutter-row treeNode">
                        <TreeNodeJGGL />
                    </Col>
                    <Col span={19} className="gutter-row treeContent">
                        <Row>
                            <Card>
